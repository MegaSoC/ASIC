/*
    ...
    Filename:      S018SP_RAM_SP_W4096_B35_M8.v
    IP code :      S018SP
    Version:       0.1.c
    CreateDate:    Apr 14, 2021

    Verilog Model for Single-PORT 
    SMIC 0.18um G Logic Process

    Configuration: -instname S018SP_RAM_SP_W4096_B35_M8 -rows 512 -bits 35 -mux 8 
    Redundancy: Off
    Bit-Write: Off
*/
...
module S018SP_RAM_SP_W4096_B35_M8(
                          Q,
			  CLK,
			  CEN,
			  WEN,
  ...
  specify
    ...
    $period(posedge CLK,4.568,CLK_CYC_flag);
    $width(posedge CLK,1.370,0,CLK_H_flag);
    $width(negedge CLK,1.370,0,CLK_L_flag);
