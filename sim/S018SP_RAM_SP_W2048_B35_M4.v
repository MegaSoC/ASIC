/*
    ...
    Filename:      S018SP_RAM_SP_W2048_B35_M4.v
    IP code :      S018SP
    Version:       0.1.c
    CreateDate:    Apr 9, 2021

    Verilog Model for Single-PORT 
    SMIC 0.18um G Logic Process

    Configuration: -instname S018SP_RAM_SP_W2048_B35_M4 -rows 512 -bits 35 -mux 4 
    Redundancy: Off
    Bit-Write: Off
*/
...
module S018SP_RAM_SP_W2048_B35_M4(
                          Q,
			  CLK,
			  CEN,
			  WEN,
  ...
  specify
    ...
    $period(posedge CLK,4.452,CLK_CYC_flag);
    $width(posedge CLK,1.335,0,CLK_H_flag);
    $width(negedge CLK,1.335,0,CLK_L_flag);
